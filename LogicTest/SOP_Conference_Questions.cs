...
namespace LogicTest
{
    ...
    public partial class SOP_Conference_Questions
    {
        ...
        public Nullable<int> SpeakerMemberId { get; set; }
        public Nullable<int> OldSpeakerMemberId { get; set; }
        public string Speech { get; set; }
        public bool Discussion { get; set; }
        public bool SpeechesAll { get; set; }
        public bool HasVoting { get; set; }
        public string VotingResult { get; set; }
        public Nullable<int> CommonQuestionId { get; set; }
